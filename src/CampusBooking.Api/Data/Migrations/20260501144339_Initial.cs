        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceIssues_AspNetUsers_AssignedById",
                        column: x => x.AssignedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceIssues_AspNetUsers_AssigneeId",
                        column: x => x.AssigneeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceIssues_AspNetUsers_ReporterId",
                        column: x => x.ReporterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceIssues_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_FacilityId_Date_TimeSlot",
                table: "Bookings",
                columns: new[] { "FacilityId", "Date", "TimeSlot" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceIssues_AssignedById",
                table: "MaintenanceIssues",
                column: "AssignedById");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceIssues_AssigneeId",
                table: "MaintenanceIssues",
                column: "AssigneeId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceIssues_FacilityId",
                table: "MaintenanceIssues",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceIssues_ReporterId",
                table: "MaintenanceIssues",
                column: "ReporterId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceIssues_Status",
                table: "MaintenanceIssues",
                column: "Status");
        }
